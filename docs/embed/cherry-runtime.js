document.addEventListener('DOMContentLoaded', () => {
    ...
    function persistBlankProjectStorage(snapshot) {
        ...
        safeStorageSet(STORAGE_KEYS.authMode, snapshot.auth.mode);
        safeStorageSet(STORAGE_KEYS.authBasicUsername, snapshot.auth.basicUsername);
        safeStorageSet(STORAGE_KEYS.authBasicPassword, snapshot.auth.basicPassword);
        safeStorageSet(STORAGE_KEYS.authJwtToken, snapshot.auth.jwtToken);
        safeStorageSet(STORAGE_KEYS.authHeaderName, snapshot.auth.headerName);
        safeStorageSet(STORAGE_KEYS.authHeaderValue, snapshot.auth.headerValue);
